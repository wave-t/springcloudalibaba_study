package com.wave.item.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.wave.client.dto.ItemDTO;
import com.wave.client.dto.OrderDetailDTO;
import com.wave.common.domain.PageDTO;
import com.wave.common.domain.PageQuery;
...
public class ItemController {
    ...
    public void updateItemStatus(@PathVariable("id") Long id, @PathVariable("status") Integer status){
        ...
        //更新商品状态的时候，根据状态信息，添加或删除es索引库中的商品信息
    }
