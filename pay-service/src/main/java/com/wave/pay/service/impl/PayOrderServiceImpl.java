package com.wave.pay.service.impl;
...
import com.wave.pay.enums.PayStatus;
import com.wave.pay.mapper.PayOrderMapper;
...
//        order.setPayTime(LocalDateTime.now());
        ...
        try {
            ...
            //打印日志记录
            log.error("支付成功发送消息失败，支付单ID：{}，交易单ID：{}", po.getId(),po.getBizOrderNo(), e);
        }
